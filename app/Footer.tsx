export default function Footer() {
    return (
        <footer className="page-footer-section secondary background-image-secondary" style={{ marginTop: "auto" }}>
            <div className="mx-4">
                <div className="row">
                    <div className="col-12 py-2 d-flex justify-content-between align-items-center">
                        <div>© {new Date().getFullYear()} by Karl Oskar Anderson, Powered by React</div>
                        <div>
